...
public interface GoogleSheetClient {
     ...
     * @return boolean is true once new table is created, it is false id such table already exists.
      */
    boolean createNewSheetTab(String newTabName) throws GoogleApiException;
     ...
     */
    boolean addWinRecordToTheSheet(String tableName, WinRecord gameResult) throws GoogleApiException;

    /**
     * Update {@link Game}'s location on Google {@link Sheet}.
     */
    String updateGameLocation(String id, String newLocation) throws GoogleApiException;
     ...
     */
    Map<String, Game> getGamesFromGoogleSheet() throws GoogleApiException;
     ...
     */
    List<WinRecord> getWinRecordsForGameFromGoogleSheet(String game) throws GoogleApiException;
}